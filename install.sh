#!/bin/bash
sudo apt install -y wtype curl wl-clipboard inotify-tools lisgd evtest libcallaudio-tools wofi libnotify-bin evremap
...
for script in alarmvol dialtone double-press fastflx1 gnome-weather-location long-press short-press squeekboard-scale gesture-shortcuts vol-buttons assistant-button-tweak ; do
